...
//    new Active("name", "id", frame, hit, adframe, "tips", "Aisha/icon", "url"),
      ...
      new Active("アイスストーム", "Ice Storm", "Aisha/Aisha29_Ice Storm.png"),
...
//    new Active("name", "id", frame, hit, adframe, "tips", "Aisha/icon", "url"),
			...
			new Active("チェーンライトニング", "Chain Lightning", "Aisha/Aisha30_Chain Lightning.png"),
...
//    new Active("name", "id", frame, hit, adframe, "tips", "Aisha/icon", "url"),
			...
			new Active("ファントムブリージング－ダークホール", "Phantom Breathing - Dark Hole", "Aisha/Aisha21a_Phantom Breathing.png"),
...
//    new Active("name", "id", frame, hit, adframe, "tips", "Aisha/icon", "url"),
			...
			new Active("ヘビープレス", "Heavy Press", "Aisha/Aisha22_Heavy Press.png"),
			new Active("インパクトハンマー", "Impact Hammer", "Aisha/Aisha27_Impact Hammer.png"),
			new Active("スクリュードライバー―トルネード", "Screw Driver – Tornado", "Aisha/Aisha28_Screw Driver.png"),
